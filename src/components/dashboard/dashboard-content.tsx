    ...
    <div className="max-w-[1600px] mx-auto space-y-6 pb-12 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 h-full">
          <Card className="rounded-[2.5rem] border shadow-sm h-full flex flex-col overflow-hidden bg-card">
            <CardHeader className="bg-primary/5 border-b shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">AI Powered Insights</p>
                </div>
              </div>
            </CardHeader>
