...
export function DashboardContent() {
  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-6 pb-12 animate-fade-in">
      ...
      {/* Coverage Region Map Placeholder */}
      <Card className="rounded-[2.5rem] border shadow-sm overflow-hidden h-[400px] relative">
        <CardHeader className="absolute top-0 left-0 z-10 bg-card/80 backdrop-blur-md w-full border-b">
          <CardTitle className="text-xl font-bold text-primary">Coverage Region</CardTitle>
        </CardHeader>
        <CardContent className="p-0 h-full">
           <div className="w-full h-full bg-muted relative group">
              ...
              <div className="absolute top-[60%] left-[60%]">
                <div className="h-8 w-8 bg-white rounded-full p-1.5 shadow-2xl border-2 border-[#005BAA] flex items-center justify-center">
                   <div className="h-full w-full bg-[#005BAA] rounded-full" />
                </div>
              </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="rounded-[2.5rem] border shadow-sm">
            <CardHeader>
              <CardTitle className="text-lg font-bold">Gender</CardTitle>
            </CardHeader>
            <CardContent className="flex flex-col items-center">
                          ...
                          if (viewBox && "cx" in viewBox && "cy" in viewBox) {
                            return (
                              <text x={viewBox.cx} y={viewBox.cy} textAnchor="middle" dominantBaseline="middle">
                                <tspan x={viewBox.cx} y={viewBox.cy} className="fill-foreground text-2xl font-black">2.432.766</tspan>
                                <tspan x={viewBox.cx} y={viewBox.cy + 24} className="fill-muted-foreground text-xs font-bold">Total Votes</tspan>
                              </text>
                            )
                          }
                        }}
              ...
              <div className="flex gap-6 mt-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-bold">Male 60%</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="h-3 w-3 rounded-full bg-primary/30" />
                  <span className="text-sm font-bold">Female 40%</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-[2.5rem] border shadow-sm">
            <CardHeader>
              <CardTitle className="text-lg font-bold">Age</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="h-48 w-full">
                <ResponsiveContainer width="100%" height="100%">
          ...
          <Card className="rounded-[2.5rem] border shadow-sm">
            <CardHeader>
              <CardTitle className="text-lg font-bold">Average Time</CardTitle>
            </CardHeader>
            <CardContent className="flex flex-col items-center justify-center">
               <div className="relative h-48 w-full flex items-center justify-center">
                  <div className="h-36 w-36 rounded-full border-[12px] border-primary/10 flex items-center justify-center relative">
                    <div className="absolute inset-0 border-[12px] border-transparent border-t-primary rounded-full rotate-45" />
                    <div className="flex flex-col items-center">
                      <span className="text-4xl font-black">25.46</span>
                      <span className="text-xs font-bold text-muted-foreground">Minutes</span>
                    </div>
                  </div>
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-primary rounded-full shadow-lg border-2 border-white" />
               </div>
               <div className="flex items-center gap-2 mt-2">
                 <TrendingUp className="h-4 w-4 text-green-500" />
                 <span className="text-sm font-bold text-green-500">+12% from last election</span>
               </div>
            </CardContent>
          </Card>
        </div>
