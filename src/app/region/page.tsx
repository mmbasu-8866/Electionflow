...
export default function RegionPage() {
  const mapCenter = useMemo(() => ({ lat: -6.9175, lng: 107.6191 }), []); // Bandung center
  const markers = useMemo(() => votingCenters.map(c => ({ lat: c.lat, lng: c.lng, title: c.name })), []);

  return (
    <PageContainer title="Region & Voting Centers">
      <h2 className="sr-only">Region Dashboard</h2>
